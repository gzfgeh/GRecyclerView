...
public class SwipeRefreshLayout extends ViewGroup {
    ...
    public SwipeRefreshLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        if (a != null) {
            refresshMode = a.getInteger(R.styleable.SwipeRefreshLayout_refresh_mode, REFRESH_MODE_SWIPE);
            setRefreshMode(refresshMode);
            boolean progressBarEnabled = a.getBoolean(R.styleable.SwipeRefreshLayout_enable_top_progress_bar, true);
